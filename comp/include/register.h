...
namespace lama::rv {
    ...
    struct Register {
        size_t regno;
    public:
        static constexpr Register temp1() {return {30};}
        static constexpr Register temp2() {return {31};}
        static constexpr Register ra() {return {1};}
        static constexpr Register gp() {return {3};}
        static constexpr Register sp() {return {2};}
        static constexpr Register fp() {return {8};}
        static constexpr Register arg(size_t argno) {
            assert(argno < 8 && "argument register number out of range");
